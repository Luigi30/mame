...
void n8x300_cpu_device::set_reg(uint8_t reg, uint8_t val, bool xmit)
{
	...
	case 0x07: m_IVL = val; xmit_lb(val, 0xFF, true, false); break; //m_lb_callback(1); m_sc_callback(1); m_iv_callback(val); break; //m_sc_callback(0, val); break;
//  OVF is read-only
	case 0x09: m_R11 = val; break;
	case 0x0f: m_IVR = val; xmit_rb(val, 0xFF, true, false); break; //m_sc_callback(1, val); break;
